...
public class SwapFile {
	...
	public boolean write(int frameNo, byte[] data, int offset) {
		return file.write(frameNo * Processor.pageSize, data, offset,Processor.pageSize) == Processor.pageSize;
	}
	
	public boolean read(int frameNo, byte[] data, int offset) {
		return file.read(frameNo * Processor.pageSize, data, offset, Processor.pageSize) == Processor.pageSize;
	}
